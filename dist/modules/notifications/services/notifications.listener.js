...
let NotificationsListener = NotificationsListener_1 = class NotificationsListener {
    ...
    async handleCrmContactCreated(payload) {
        this.logger.log(`crm.contact.created received: contact=${payload.contactId} org=${payload.orgId} email=${payload.email}`);
    }
};
exports.NotificationsListener = NotificationsListener;
__decorate([
    (0, event_emitter_1.OnEvent)('crm.contact.created'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], NotificationsListener.prototype, "handleCrmContactCreated", null);
